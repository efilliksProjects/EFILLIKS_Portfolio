...
(function initContactForm() {
  ...
  function validate() {
    ...
    if (consent && !consent.checked) { setErr('privacy', 'You must agree to the Privacy Policy to continue.'); ok = false; }
  ...
  form.addEventListener('submit', async e => {
    ...
    /*
      ...
      Option A — Formspree: fetch('https://formspree.io/f/YOUR_ID', { method:'POST', body: new FormData(form) })
